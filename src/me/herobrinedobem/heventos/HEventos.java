...
public class HEventos extends JavaPlugin {
	...
	private void loadDependencies() {
		if (!setupSimpleClans()) {
			Bukkit.getConsoleSender().sendMessage("�9[HEventosReloaded] �cSimpleClans n�o encontrado!");
		}
		if (!setupEconomy()) {
			Bukkit.getConsoleSender().sendMessage("�9[HEventosReloaded] �cVault n�o encontrado!");
		}
		if (!setupLegendChat()) {
			Bukkit.getConsoleSender().sendMessage("�9[HEventosReloaded] �cLegendChat n�o encontrado!");
		}
	}
